...
WYCAPI void swizzle_32bpp(uint32_t *dst, uint32_t dx, uint32_t dy, uint32_t dw, uint32_t dh, const uint32_t *src, uint32_t sw, uint32_t sh, uint32_t spitch);
...
WYCAPI void linearize_32bpp(uint32_t *dst, uint32_t dw, uint32_t dh, uint32_t dpitch, const uint32_t *src, uint32_t sx, uint32_t sy, uint32_t sw, uint32_t sh);
...
WYCAPI void swizzle_32bpp_fast(uint32_t *dst, uint32_t dw, const uint32_t *src, uint32_t sw, uint32_t sh, uint32_t spitch);
...
// "dw" is the width of "dst" texture. It should be padded to 64 boundaries
WYCAPI void linearize_32bpp_fast(uint32_t *dst, uint32_t dw, uint32_t dh, uint32_t dpitch, const uint32_t *src, uint32_t sw);
