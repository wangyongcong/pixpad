...
#define INPUT_ATTRIBUTE_LIST_END {wyc::EAttributeUsage(0), 0} }; return  ls_input_attribs;
...
#define OUTPUT_ATTRIBUTE_LIST_END {wyc::EAttributeUsage(0), 0} }; return ls_output_attribs;

#define ATTRIBUTE_SLOT(usage, component) { wyc::EAttributeUsage(usage), uint8_t(component) },
